...
export function YourReview({ userId }: { userId: string }) {
  ...
  const isReviewRequestsTabSelected = selectedTab === OUTGOING_REVIEWS_TAB_ID;

  return (
    <div>
      <div
        className="flex border border-zinc-200 border-b-0 divide-x divide-zinc-200 w-max"
        role="tablist"
      >
        ...
        >
          ...
          >
            ...
            <div className="text-start">
              ...
              <p className="text-sm">Reviews from other businesses to yours</p>
            </div>
          </div>
        </button>
        ...
        <button
          ...
          className={cn("py-2 px-4 pr-20 border-b-2", {
            "border-b-2 border-purple-700": isReviewRequestsTabSelected,
          })}
          role="tab"
          aria-selected={isReviewRequestsTabSelected}
          aria-controls={OUTGOING_REVIEW_PANEL_ID}
          onClick={() => setSelectedTab(OUTGOING_REVIEWS_TAB_ID)}
        >
          <div
            className={cn("flex items-center gap-4", {
              "opacity-20": !isReviewRequestsTabSelected,
            })}
          >
            <svg
              width="30"
            ...
            <div className="text-start">
              ...
              <p className="text-sm">
                Reviews requests from your businesses to others
              </p>
            </div>
          </div>
        </button>
